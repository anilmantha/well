...
public interface IMasterService {
	...
	public List<Skillmaster> getByName(String skillname, int i);
	...
	public List<Qualificationmaster> getQualificationByName(String qualification,int i);
	public Pagination qualifyCount(String qualification);
	public List<Marketingvouchermaster> getMarketingVoucher();
	public List<Marketingvouchermaster> getMvoucherByName(String mcompany,int i);
	...
	public List<Roommaster> getRoomsByNum(Integer roomnum,int i);
	...
	public List<Segmentmaster> getSegmentByName(String segname,int i);
