...
<%
	try{
		List<Map<String,?>> datasource=(List<Map<String,?>>)request.getAttribute("ticketsList");
		String type = request.getAttribute("generatetype").toString();
		
		JRDataSource jrdatasource=new JRBeanCollectionDataSource(datasource);
		String jrXmlFile=session.getServletContext().getRealPath("/reports/TicketReport.jrxml");
		...
		if(type.equals("excel")){
			...
			response.setHeader("Content-Disposition", "attachment; filename=" + "TicketsReport" + ".xlsx"); 
