...
<%
	try{
		List<Map<String,?>> datasource=(List<Map<String,?>>)request.getAttribute("therapistTransactionList");
		String type = request.getAttribute("generatetype").toString();
		
		JRDataSource jrdatasource=new JRBeanCollectionDataSource(datasource);
		String jrXmlFile=session.getServletContext().getRealPath("/reports/therapisttransaction.jrxml");
		...
		if(type.equals("excel")){
			...
			response.setHeader("Content-Disposition", "attachment; filename=" + "TherapistTransactionReport" + ".xls"); 
