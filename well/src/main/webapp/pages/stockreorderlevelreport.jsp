...
<%
	try{
		List<Map<String,?>> datasource=(List<Map<String,?>>)request.getAttribute("reOrderLevelList");
		String type = request.getAttribute("generatetype").toString();
		
		JRDataSource jrdatasource=new JRBeanCollectionDataSource(datasource);
		String jrXmlFile=session.getServletContext().getRealPath("/reports/stockreorderlevel.jrxml");
		...
		if(type.equals("excel")){
			...
			response.setHeader("Content-Disposition", "attachment; filename=" + "StockReorderLevelReport" + ".xlsx"); 
