		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Add Supplier Details</h3>
				</div>
				<div class="panel-body">
					<div class="col-md-11">
					<form action="savenewsupplier" method="post">
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
									...
									<tr>
										...
										<td class="col-md-3"><input type="text"
											class="form-control" id="phone2" name="phone2" maxlength="10"
											onkeypress="return isNumber(event)" /></td>
										<td width="5%">&nbsp;</td>
									...
									<tr>
										...
										<td class="col-md-3"><input type="text"
											...
											name="contactperson3" /></td>
									</tr>
									<tr>
										<td width="12%"><label>Address3</label></td>
										<td class="col-md-3"><input type="text"
											class="form-control"  id="address3" name="address3" /></td>

										<td width="5%">&nbsp;</td>
										<td width="14%"><label>Phone3</label></td>
										<td class="col-md-3"><input type="text"
											class="form-control" id="phone3" name="phone3" maxlength="10"
											onkeypress="return isNumber(event)" /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<div class="form-group">
											...
											<td class="col-md-3"><input type="checkbox"
												class="checkbox " value="true" name="wholesale"></td>
										</div>
										...
										<td class="col-md-3"><textarea class="form-control"
												rows="5" id="remarks" maxlength="255" name="remarks"></textarea></td>
										<td>&nbsp;</td>
									</tr>
									<tr>
										<td>
