		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Client Date Of Birth Search</h3>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		/* 	 alert("HIIII"+month);
			...
			$.ajax({
				type : "GET",
				async : false,
				url : "guestdobsearch?month=" + month + "&fromDate=" + fromDate
						+ "&toDate=" + toDate,
...
<script>
	 function msg() {
		...
		document.getElementById("exportform").action = 'generateClientDOBReports?month='+month+'&fromDate='+fromDate+'&toDate='+toDate+'&generate='+ generatetype;
