...
<%
	try{
		List<Map<String,?>> datasource=(List<Map<String,?>>)request.getAttribute("InventoryList");
		String type = request.getAttribute("generatetype").toString();
		
		JRDataSource jrdatasource=new JRBeanCollectionDataSource(datasource);
		String jrXmlFile=session.getServletContext().getRealPath("/reports/inventoryreport.jrxml");
