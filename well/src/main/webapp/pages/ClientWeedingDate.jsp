...
<%
	try{
		...
		String jrXmlFile=session.getServletContext().getRealPath("/reports/guestWDReport.jrxml");
		...
		if(type.equals("excel")){
			...
			response.setHeader("Content-Disposition", "attachment; filename=" + "guestWDReport" + ".xlsx"); 
